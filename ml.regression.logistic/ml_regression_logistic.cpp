...
namespace ml
{
    ...
    class ml_regression_logistic : ml_base
    {
    ...
    // Attribute setters
    void ml_regression_logistic::set_max_iterations(int max_iterations)
    {
        regressifier.setMaxNumIterations(max_iterations);
    }
    
    void ml_regression_logistic::set_min_change(float min_change)
    {
    ...
    void ml_regression_logistic::set_training_rate(float training_rate)
    {
    ...
    // Attribute getters
    void ml_regression_logistic::get_max_iterations(int &max_iterations) const
    {
        max_iterations = regressifier.getMaxNumIterations();
    }
    
    void ml_regression_logistic::get_min_change(float &min_change) const
    {
        error("function not implemented");
        //        min_change = regressifier.getMinChange();
    }
    
    void ml_regression_logistic::get_training_rate(float &training_rate) const
    {
        training_rate = regressifier.getLearningRate();
    }
    
    // Methods
    void ml_regression_logistic::train()
    {
    ...
    void ml_regression_logistic::clear()
    {
        regressifier.clear();
        ml_base::clear();
    }
    
    void ml_regression_logistic::classify(int argc, const t_atom *argv)
    {
        GRT::UINT numSamples = labelledRegressionData.getNumSamples();
    ...
    void ml_regression_logistic::usage()
    {
        post("%s", ML_POST_SEP);
        post("Attributes:");
        post("%s", ML_POST_SEP);
